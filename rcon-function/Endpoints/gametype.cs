        ...
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "get", Route = null)] HttpRequest req, ILogger log)
        {
            ...
            try
            {
                ...
                if (gameType == GameTypes.deathmatch)
                {
                    ...
                    var resp = await rconClient.ExecuteCommandAsync($"game_type 1;game_mode 2;exec gamemode_deathmatch;map {currentMap}; mapgroup {currentMapGroup};sv_infinite_ammo 2;mp_teammates_are_enemies 1;mp_timelimit 0;mp_tkpunish 0;mp_warmup_pausetimer 1;mp_warmuptime 1;bot_quota 0;mp_friendlyfire 1;mp_autokick 0;mp_autoteambalance 0;mp_buy_allow_grenades 0;mp_buy_allow_guns 0;mp_ct_default_grenades \"\";mp_ct_default_melee weapon_knife;mp_ct_default_primary weapon_ak47;mp_ct_default_secondary weapon_deagle;mp_t_default_grenades \"\";mp_t_default_melee weapon_knife;mp_t_default_primary weapon_ak47;mp_t_default_secondary weapon_deagle;mp_free_armor 2;mp_death_drop_gun 0;mp_defuser_allocation 0;mp_give_player_c4 0;mp_limitteams 0;mp_logdetail 0;mp_match_can_clinch 1;mp_match_end_restart 1;mp_randomspawn 1;mp_respawn_on_death_ct 1;mp_respawn_on_death_t 1;");
